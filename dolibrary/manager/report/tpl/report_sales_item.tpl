  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      {                        
        ...
        location.href='report_sales_item.php?s_dept='+dept+'&s_cust='+cust+'&s_cate='+cate+
                      '&s_pay_status='+invt_pay+'&p_daterange='+ daterange + '&p_datetype=' + type;
      }
...
<!-- LOOP END 'LP' -->                      
                      ...
                      <td><strong>{{T_G_QTY}}</strong></td>
                      <td></td>
                      <td></td>                                                           
                      <td><strong>$ {{T_G_PRICE}}</strong></td>
                      <td><strong>$ {{T_G_TOTAL_PRICE}}</strong></td>
                      <td></td>                        
                      </tr>
                    </tbody>
                  </table>                    
